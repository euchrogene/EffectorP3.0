...
# Configuration
REPO_URL="https://github.com/euchrogene/EffectorP3.0.git"
REPO_DIR="EffectorP3.0"
EXE_FILE="EffectorP3.0"
PIPELINE_ENTRY="$EXE_FILE => A software to identify fungal effector proteins from secretomes, distinguishing them from non-effector secreted proteins"
